<?php include './inc/header.php'; ?>
    ...
    <div class="mt-4 mb-3 d-grid gap-2">
      ...
      <a style="background-color:#800000; color:white; font-family:Poppins; font-weight:700;" class="btn btn-lg" href="/PHP-CVMS/CVMS/about.php" role="button">Update Old Form</a>
    </div>
